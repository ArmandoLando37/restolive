...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-slate-900">Ajouter un livreur</h1>
    <p class="mt-1 text-xs text-slate-400">Nouveau membre de l'equipe de livraison</p>
</div>

<div class="max-w-2xl rounded-2xl border border-slate-100/80 bg-white p-6">
    <form method="post" action="${pageContext.request.contextPath}/livreurs/ajouter" class="space-y-5">
        <div>
